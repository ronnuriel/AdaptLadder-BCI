...
Simple distribution shift & Mean/scale correction & \textbf{Do not rely on moment matching} & Moment match: 22.73\% PER & Channel-wise mean/variance alignment does not capture the decoder-relevant drift. \\
