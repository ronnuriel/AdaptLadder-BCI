...
\textbf{T15.} The main experiments use T15 copy-task neural features from the official brain-to-text dataset~\cite{card2024accurate}. We evaluate 41 validation sessions with ground-truth phoneme labels. Neural inputs are passed through the official GRU checkpoint and decoded greedily at the phoneme level. During evaluation, repeated symbols and blank tokens are removed using the standard CTC collapse rule before computing PER.
