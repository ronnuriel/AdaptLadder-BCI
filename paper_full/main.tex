...
Condition & PER & Note \\
\midrule
Native-day & 9.06\% & correct layer \\
Fixed early & 28.81\% & 40/41 harmed \\
Fixed middle & 22.67\% & stress source \\
Fixed late & 34.43\% & 40/41 harmed \\
Target z-score & 22.75\% & fails \\
Moment match & 22.73\% & fails \\
Diag. affine, $K=20$ & 20.21\% & adapter \\
Input layer, $K=20$ & 18.59\% & 20 epochs \\
\bottomrule
\end{tabular}
\label{tab:ladder}
\end{table}
