...
\begin{table}[t]
\centering
\caption{T15 decoder-facing stress test and adaptation ladder. Fixed-source and moment-correction rows use the middle source \texttt{t15.2023.11.26}. Learned adapter rows use $K=20$ calibration trials and are evaluated on remaining trials. Lower PER is better.}
\scriptsize
\begin{tabular}{lccc}
\toprule
...
Labeled $K$ trials & Calibrate input & $K=20$ partial recovery \\
