...
\midrule
Recent previous state & Reuse previous layer & strongest simple baseline \\
...
Small labeled window & Input calibration & partial recovery at $K=20$ \\
Non-recent match & Retrieve older state & lower subspace mismatch \\
Behavior shift & Index behavior state & inner-speech geometry \\
\bottomrule
\end{tabular}
